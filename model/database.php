...
require '/home/chrogers/config.php';
...
class Database
{
    ...
    function writeOrder($order)
    {
        ...
        //5. Process the results - SKIP (only need this when you have a select query
    ...
    function getOrders()
    {
        ...
        //Write to database
        //1. Define the query
        $sql = "SELECT * FROM food_order ORDER BY date_time DESC";
